...
Terminus position change analysis was conducted using MaQiT (https://liverpoolgee.wordpress.com/maqit/), with the curvilinear box method being employed. The centreline shapefile used and the MaQiT output CSV are provided. The script 'terminus_position' uses this output CSV file to plot graphs of terminus position change over time. 
